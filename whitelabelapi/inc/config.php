<?php
    ...
    ////need aj hacket; product id 5216 or 4790 -- package with products that have events with date and time
    //http://beta.junction6travel.com/jsonservice/v1/
    ...
    define('J6_BASE_URL','http://junction6.dev/jsonservice/v1/');
