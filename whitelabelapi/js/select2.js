...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        // multi
        createContainer: function () {
			  var showSearchInput = this.showSearchInput = (typeof this.opts.preventSearchInput === 'undefined') ? true : !this.opts.preventSearchInput;
			  var hidden_class = '';
			  if (!showSearchInput) {
				  hidden_class = ' select2-search-hidden';
			  }
            var container = $("<div></div>", {
                ...
                "    <input type='text' autocomplete='off' class='select2-input"+hidden_class+"'>" ,
                "  </li>" ,
                "</ul>" ,
